...
class ShararaDirectionalityController {
  ...
  TextDirection get currentDirection => directionalityNotifier.value??instance.cachedDirectionality;
  static TextDirection get direction => instance.currentDirection;
